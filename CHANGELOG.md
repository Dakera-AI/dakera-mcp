...
- **Glama.ai integration files** — added `glama.json` claim file and Glama score badge to README
  for server directory discoverability. ([#99](https://github.com/Dakera-AI/dakera-mcp/pull/99),
  [#100](https://github.com/Dakera-AI/dakera-mcp/pull/100))
- **Improved tool descriptions for TDQS scoring** — rewrote all 86 MCP tool descriptions with
  richer context, parameter explanations, and usage examples to improve Glama quality scores.
  ([#102](https://github.com/Dakera-AI/dakera-mcp/pull/102))
- **GitHub Release binary assets** — release workflow now uploads pre-built linux x86_64 binary,
  tarball, and SHA256 checksums to GitHub Releases.
  ([#101](https://github.com/Dakera-AI/dakera-mcp/pull/101))
