...
mod tests {
    ...
    fn test_tool_definitions_contain_expected_tools() {
        ...
        // v0.2.2 tools
        assert!(names.contains("dakera_namespace_configure"), "dakera_namespace_configure missing from tool definitions");
        assert!(names.contains("dakera_knowledge_network_cross_agent"), "dakera_knowledge_network_cross_agent missing from tool definitions");
    }
